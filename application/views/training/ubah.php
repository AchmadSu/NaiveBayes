                ...
                <form action="" method="post" accept-charset="utf-8">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control"name="jml_penghasilan" value="<?= $ubah['jml_penghasilan'] ?>">
                    </div>
                    <input type="submit" name="save" class="btn btn-success" value="Update Data">
                  </div>
                  <!-- /.card-body -->
                </form>
              </div>
